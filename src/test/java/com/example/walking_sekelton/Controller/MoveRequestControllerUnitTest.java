...
class MoveRequestControllerUnitTest {
  ...
  @Mock private MoveRequestService moveRequestService;

  @InjectMocks private MoveRequestController moveRequestController;

  @Test
  void createMoveRequest_shouldReturnCreated() {
    MoveRequest moveRequest =
        new MoveRequest(
            1L, "Bob Baumeister", "Mühlgasse 45", "Mühlgasse 342", LocalDate.parse("2025-07-31"));
